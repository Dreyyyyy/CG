...
int main()
{
	...
	while (!glfwWindowShouldClose(Window))
	{
		...
		ModelMatrixEarth = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 60.0, 0.0f, cos((float)CurrentTime) * 60.0));
		...
		ModelMatrixMercury = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 20.0, 0.0f, cos((float)CurrentTime) * 20.0));
		...
		ModelMatrixVenus = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 40.0, 0.0f, cos((float)CurrentTime) * 40.0));
		...
		ModelMatrixMars = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 80.0, 0.0f, cos((float)CurrentTime) * 80.0));
		...
		ModelMatrixJupter = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 100.0, 0.0f, cos((float)CurrentTime) * 100.0));
		...
		ModelMatrixSaturn = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 120.0, 0.0f, cos((float)CurrentTime) * 120.0));
		...
		ModelMatrixUranus = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 140.0, 0.0f, cos((float)CurrentTime) * 140.0));
		...
		ModelMatrixNeptune = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 160.0, 0.0f, cos((float)CurrentTime) * 160.0));
		...
		ModelMatrixMoon = glm::translate(glm::identity<glm::mat4>(), glm::vec3(sin((float)CurrentTime) * 60.0, 5.0f, cos((float)CurrentTime) * 50.0));
